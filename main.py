...
function editContactPrefs(phone){
  var ct=contacts[phone];
  if(!ct)return;
  var h='<div style="margin-bottom:16px"><button class="ba" style="font-size:12px;padding:4px 12px" onclick="openContactCard(\''+phone+'\')">&#8592; Retour</button></div>';
  h+='<div class="card" style="padding:24px;margin-bottom:16px">';
  ...
  h+='<button class="ba" style="background:var(--acg);color:white;border:none;padding:10px 24px;font-weight:700" onclick="saveContactPrefs(\''+phone+'\')">Enregistrer</button>';
  h+='<button class="ba" style="padding:10px 24px" onclick="openContactCard(\''+phone+'\')">Annuler</button>';
  h+='</div></div>';
