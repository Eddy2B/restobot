...
<div class="lbox">
  ...
  <div id="forgotPwdForm" style="display:none">
    ...
    <div id="forgotStep2" style="display:none">
      ...
      <input class="linp" type="password" id="newPwd" placeholder="Nouveau mot de passe (min. 6 car.)" style="margin-bottom:8px">
...
async def api_forgot_password(request: Request):
    ...
    if not db_pool:
        return {"error": "Base de donnees non disponible"}
