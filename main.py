    ...
    try:
        async with db_pool.acquire() as conn:
            ...
            for row in rows:
                ...
                review_queue[rid] = []
                contacts[rid] = {}
                stats[rid] = {"messages_today": 0, "bookings_today": 0, "languages": {}, "last_reset": date.today().isoformat()}
...
def extract_booking_date(message: str) -> str:
    ...
    if m:
        ...
        try:
            ...
            pass
    if "demain" in msg or "tomorrow" in msg or "domani" in msg:
...
def track_stats(rid: str, is_booking: bool = False, language: str = "fr"):
    st = stats.get(rid, {"messages_today": 0, "bookings_today": 0, "languages": {}, "last_reset": date.today().isoformat()})
...
<link rel="icon" type="image/svg+xml" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'%3E%3Ccircle cx='12' cy='5' r='2.5' fill='%234ECDC4'/%3E%3Ccircle cx='5' cy='18' r='2.5' fill='%232D7DD2'/%3E%3Ccircle cx='19' cy='18' r='2.5' fill='%232D7DD2'/%3E%3Cline x1='12' y1='7.5' x2='5' y2='15.5' stroke='%234ECDC4' stroke-width='1.8'/%3E%3Cline x1='12' y1='7.5' x2='19' y2='15.5' stroke='%232D7DD2' stroke-width='1.8'/%3E%3Cline x1='5' y1='18' x2='19' y2='18' stroke='%232D7DD2' stroke-width='1.8'/%3E%3C/svg%3E">
...
<div class="lbox">
  <div class="l-logo"><div class="l-icon"><svg viewBox="0 0 24 24"><circle cx="12" cy="5" r="2.5" fill="#4ECDC4"/><circle cx="5" cy="18" r="2.5" fill="#2D7DD2"/><circle cx="19" cy="18" r="2.5" fill="#2D7DD2"/><line x1="12" y1="7.5" x2="5" y2="15.5" stroke="url(#lgr1)" stroke-width="1.8"/><line x1="12" y1="7.5" x2="19" y2="15.5" stroke="url(#lgr1)" stroke-width="1.8"/><line x1="5" y1="18" x2="19" y2="18" stroke="#2D7DD2" stroke-width="1.8"/><defs><linearGradient id="lgr1" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#4ECDC4"/><stop offset="100%" stop-color="#2D7DD2"/></linearGradient></defs></svg></div><div class="lwm">GuestScale</div></div>
...
<div class="sidebar">
  <div class="sb-b"><div class="sb-logo"><div class="sb-icon"><svg viewBox="0 0 24 24"><circle cx="12" cy="5" r="2.5" fill="#4ECDC4"/><circle cx="5" cy="18" r="2.5" fill="#2D7DD2"/><circle cx="19" cy="18" r="2.5" fill="#2D7DD2"/><line x1="12" y1="7.5" x2="5" y2="15.5" stroke="url(#sgr1)" stroke-width="1.8"/><line x1="12" y1="7.5" x2="19" y2="15.5" stroke="url(#sgr1)" stroke-width="1.8"/><line x1="5" y1="18" x2="19" y2="18" stroke="#2D7DD2" stroke-width="1.8"/><defs><linearGradient id="sgr1" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#4ECDC4"/><stop offset="100%" stop-color="#2D7DD2"/></linearGradient></defs></svg></div><div><div class="sb-wm">GuestScale</div><div class="sb-s">Restaurant AI</div></div></div></div>
  <div class="sb-n">
...
var pageTitles={overview:"Vue d'ensemble",floorplan:"Plan de salle",bookings:"Réservations",menu:"Menu",conversations:"Conversations",reviews:"Avis",contacts:"Contacts",config:"Configuration",stats:"Statistiques",account:"Mon compte"};
...
function renderOnboarding(){
  ...
  // Logo
  h+='<div style="display:flex;align-items:center;gap:10px;margin-bottom:6px"><div style="width:36px;height:36px;background:var(--acg);border-radius:9px;display:flex;align-items:center;justify-content:center"><svg viewBox="0 0 24 24" style="width:20px;height:20px"><circle cx="12" cy="5" r="2.5" fill="#4ECDC4"/><circle cx="5" cy="18" r="2.5" fill="#fff"/><circle cx="19" cy="18" r="2.5" fill="#fff"/><line x1="12" y1="7.5" x2="5" y2="15.5" stroke="#fff" stroke-width="1.8"/><line x1="12" y1="7.5" x2="19" y2="15.5" stroke="#fff" stroke-width="1.8"/><line x1="5" y1="18" x2="19" y2="18" stroke="#fff" stroke-width="1.8"/></svg></div><div style="font-size:18px;font-weight:800;color:var(--t);letter-spacing:-.02em">GuestScale</div></div>';
...
async def api_register(request: Request):
    ...
    try:
        ...
        contacts[rid_str] = {}
        stats[rid_str] = {"messages_today": 0, "bookings_today": 0, "languages": {}, "last_reset": date.today().isoformat()}
...
async def api_tag_contact(request: Request):
    ...
    tag = data.get("tag", "")
    rid_contacts = contacts.get(rid, {})
    if phone in rid_contacts and tag:
