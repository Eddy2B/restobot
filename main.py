...
function renderFloorplan(c){
  ...
  if(fpMode==='resa'){h+='<div id="fpResaPopup" style="display:none;margin-top:12px;padding:16px;background:var(--card);border:1px solid var(--b);border-radius:12px"><div id="fpResaContent"></div></div>'}
