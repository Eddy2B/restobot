...
<div class="lbox">
  ...
  <div class="lcd">
    ...
    <div style="position:relative">
      <input class="linp" type="password" id="loginPwd" placeholder="Mot de passe" autocomplete="current-password" data-loginInput oninput="document.getElementById('loginError').style.display='none';this.style.borderColor='#374151'">
      <button data-togglePwd style="position:absolute;right:12px;top:50%;transform:translateY(-50%);background:none;border:none;cursor:pointer;font-size:16px;color:#6B7280;padding:4px" id="pwdToggle" type="button" title="Afficher le mot de passe">&#128065;</button>
    </div>
    <button class="lbtn" type="button" data-doLogin>Continuer</button>
  </div>
</div>
</div>
...
function doLogin(){
  ...
  var pwd=inp.value;
  console.log('doLogin called, pwd length:', pwd.length);
