...
# send_brevo_welcome now in brevo_service.py
# send_admin_notification_email now in brevo_service.py
# send_subscription_welcome_emails now in brevo_service.py
# send_cancellation_emails now in brevo_service.py
